...
//            tsdbEngineSample.shutdown();
            ...
            final TimeRangeQueryRequest timeRangeQueryRequest = new TimeRangeQueryRequest("", new Vin("XrPyN8aeiZnQWVmD1".getBytes(StandardCharsets.UTF_8)), requestedColumns, 0, Long.MAX_VALUE);
