...
//            tsdbEngineSample.shutdown();
            ...
            list.add(new Vin("Yk6Hml0zPusCR6c3B".getBytes(StandardCharsets.UTF_8)));
            ...
            final TimeRangeQueryRequest timeRangeQueryRequest = new TimeRangeQueryRequest("", new Vin("Yk6Hml0zPusCR6c3B".getBytes(StandardCharsets.UTF_8)), requestedColumns, 11000, 21000);
            ArrayList<Row> rowArrayList = tsdbEngineSample.executeTimeRangeQuery(timeRangeQueryRequest);
            final TimeRangeAggregationRequest timeRangeAggregationRequest = new TimeRangeAggregationRequest("", new Vin("Yk6Hml0zPusCR6c3B".getBytes(StandardCharsets.UTF_8)), "7double", 11000, 21000, Aggregator.MAX);
            rowArrayList = tsdbEngineSample.executeAggregateQuery(timeRangeAggregationRequest);
            final TimeRangeDownsampleRequest timeRangeDownsampleRequest = new TimeRangeDownsampleRequest("", new Vin("Yk6Hml0zPusCR6c3B".getBytes(StandardCharsets.UTF_8)), "7double", 9120000L, 10923000L, Aggregator.AVG, 1000L, new CompareExpression(new ColumnValue.DoubleFloatColumn(0.7d), CompareExpression.CompareOp.EQUAL));
