...
//                            rowList.add(new Row( vin, atomicLong.getAndIncrement(), columns));
//                        }
//                        try {
...
//            tsdbEngineSample.shutdown();
            ...
            list.add(new Vin("IaEqaRj8SCUtDJQCz".getBytes(StandardCharsets.UTF_8)));
            ...
            final TimeRangeQueryRequest timeRangeQueryRequest = new TimeRangeQueryRequest("", new Vin("IaEqaRj8SCUtDJQCz".getBytes(StandardCharsets.UTF_8)), requestedColumns, 0, Long.MAX_VALUE);
