...
public class QueryTest {
    ...
    public static void main(String[] args) {
        ...
        String[] bigIntKey = {"LATITUDE","LONGITUDE", "YXMS"};
...
//                            columns.put("LATITUDE", new ColumnValue.IntegerColumn(Math.abs(random.nextInt(100))));
//                            columns.put("LONGITUDE", new ColumnValue.IntegerColumn(Math.abs(random.nextInt(100))));
//                            columns.put("YXMS", new ColumnValue.IntegerColumn(Math.abs(random.nextInt(100))));
...
//            tsdbEngineSample.shutdown();
            ...
            list.add(new Vin("qZjsyXXKqasjGu51M".getBytes(StandardCharsets.UTF_8)));
            ...
            final TimeRangeQueryRequest timeRangeQueryRequest = new TimeRangeQueryRequest("", new Vin("qZjsyXXKqasjGu51M".getBytes(StandardCharsets.UTF_8)), requestedColumns, 0, Long.MAX_VALUE);
