...
//        System.out.println(String.format("freeMemory:%s M, totalMemory:%s, maxMemory:%s", free, total, max));
//    }
//
...
//        printFreeMemory();
//        System.out.println("getDirectBufferPoolMBean: " + getDirectBufferPoolMBean().getTotalCapacity() / 1024.0 / 1024.0);
//        System.out.println("getNioBufferPool:" + getNioBufferPool().getTotalCapacity() / 1024.0 / 1024.0);
//    }
//
