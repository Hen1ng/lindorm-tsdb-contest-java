...
public class StaticsUtil {
    ...
    public static AtomicLong COMPRESS_TOTAL_TIME = new AtomicLong(0);
    public static AtomicLong COMPRESS_TIMES = new AtomicLong(0);

    public static AtomicLong DOWNSAMPLE_TIME = new AtomicLong(0);
    public static AtomicLong DOWNSAMPLE_FETCH_DATA_TIME = new AtomicLong(0);
    ...
    public static AtomicLong AGG_FETCH_TIME = new AtomicLong(0);
