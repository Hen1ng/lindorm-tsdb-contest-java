...
//        MapIndex.loadMapFromFile(indexFile);
    ...
    public void shutdown() {
        ...
        System.out.println("MAP_COMPRESS_TIME : " + StaticsUtil.MAP_COMPRESS_TIME.get());
        System.out.println("PREPARE_DATA_TIME : " + StaticsUtil.PREPARE_DATA_TIME.get());
        System.out.println("FOR_LOOP_TIME : " + StaticsUtil.FOR_LOOP_TIME.get());
        System.out.println("COMPRESS_TIME : " + StaticsUtil.COMPRESS_TIME.get());
        System.out.println("PUT_TIME : " + StaticsUtil.PUT_TIME.get());
        System.out.println("APPEND_TIME : " + StaticsUtil.APPEND_TIME.get());
        System.out.println("WRITE_TOTAL : " + StaticsUtil.WRITE_TOTAL.get());
        System.out.println("TIME_RANGE_STRING_COMPRESS_TOTAL: " + StaticsUtil.TIME_RANGE_STRING_COMPRESS_TOTAL.get());
        System.out.println("TIME_RANGE_INT_COMPRESS_TOTAL: " + StaticsUtil.TIME_RANGE_INT_COMPRESS_TOTAL.get());
        System.out.println("TIME_RANGE_DOUBLE_COMPRESS_TOTAL: " + StaticsUtil.TIME_RANGE_DOUBLE_COMPRESS_TOTAL.get());
        System.out.println("TIME_RANGE_READ_FROM_FILE_TOTAL: " + StaticsUtil.TIME_RANGE_READ_FROM_FILE_TOTAL.get());
        System.out.println("TIME_RANGE_TOTAL: " + StaticsUtil.TIME_RANGE_TOTAL.get());
                    ...
                    if (bigBucket.getMinTimestamp() >= aggregationReq.getTimeLowerBound() && bigBucket.getMaxTimestamp() <= aggregationReq.getTimeUpperBound() - 1){
                        ...
                        for (Index index : indices) {
                            if (index.getMinTimestamp() >= aggregationReq.getTimeLowerBound() && index.getMaxTimestamp() <= aggregationReq.getTimeUpperBound() - 1) {
                                ...
                                timeRangeColumnValue.addAll(fileService.getSingleValueByIndex(aggregationReq.getVin(), timeLower, timeUpper, index, requestedColumns, i1));
                    ...
                    switch (aggregator) {
                        case AVG:
                            for (Index index : indices) {
                                ...
                                ArrayList<ColumnValue> rowArrayList = fileService.getSingleValueByIndex(vin, startTime, endTime, index, requestedColumns, i1);
                        ...
                        case AVG:
                            ...
                            for (Index index : indices) {
                                if (index.getMinTimestamp() >= startTime && index.getMaxTimestamp() <= endTime - 1 && index.getAggBucket().getiMin(columnIndex) > integerValue) {
                                    ...
                                    //[start,end) Row
                                    timeRangeRow.addAll(fileService.getSingleValueByIndex(vin, startTime, endTime, index, requestedColumns, i1));
                                }
                            }
